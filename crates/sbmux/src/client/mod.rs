...
//
// The legacy shared-daemon `*_data` library variants (which bound `sbmux.sock`)
...
// per-session world (D-SOCKDIR mirror). Nothing binds or expects `sbmux.sock`
// anymore except the §5.3 legacy-visibility probe (`discovery::probe_legacy_socket`).
// ===========================================================================
