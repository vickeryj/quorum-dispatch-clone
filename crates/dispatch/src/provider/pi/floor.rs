...
"#;
    ...
    fn floor_session_dir_is_dedicated_and_stable() {
        ...
        assert_ne!(d1, floor_session_dir(root, "sess-xyz"), "distinct per session");
    }
    ...
    fn floor_may_fire_only_when_no_live_resident() {
        ...
        assert!(!floor_may_fire(true, true, true, true), "alive+ok ⇒ NEVER floor");
